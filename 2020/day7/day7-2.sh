...
# the outputted variables need to be an hierarchial order which I still need to figure out a place here
...
# and then echo the correct variable to get the answer
source ${output}
echo $((${shiny_gold} - 1))
